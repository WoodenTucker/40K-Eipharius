...
/area/cadiaoutpost/oa/building
	name = "Building"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building1
	name = "Building1"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building2
	name = "Building2"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building3
	name = "Building3"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building4
	name = "Building4"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building5
	name = "Building5"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building6
	name = "Building6"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building7
	name = "Building7"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building8
	name = "Building8"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building9
	name = "Building9"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building10
	name = "Building10"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building11
	name = "Building11"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building12
	name = "Building12"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building13
	name = "Building13"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building14
	name = "Building14"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building15
	name = "Building15"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building16
	name = "Building16"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building17
	name = "Building17"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building18
	name = "Building18"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building19
	name = "Building19"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/building/building20
	name = "Building20"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/city
	name = "Town"
	icon_state = "crew_quarters"
	requires_power = FALSE
	dynamic_lighting = 1

/area/cadiaoutpost/oa/city/Entered(mob/living/L,  atom/A)
	. = ..()
	if(istype(L) && !istype(A, /area/cadiaoutpost/oa/city))//Doesn't work but this does stop the lag.
		L.overlay_fullscreen("snowfall_heavy_old", /obj/screen/fullscreen/snowstorm)

/area/cadiaoutpost/oa/city/Exited(mob/living/L, area/A)
	. = ..()
	if(istype(L) && !istype(A, /area/cadiaoutpost/oa/city))
		L.clear_fullscreen("snowfall_heavy_old")

/area/cadiaoutpost/oa/tunnel
	name = "Tunnel"
	icon_state = "maintcentral2"
	requires_power = FALSE
	dynamic_lighting = 1
...
/area/cadiaoutpost/oa/shuttle/monorail
	name = "Monorail"
	icon_state = "shuttle"

/area/cadiaoutpost/oa/shuttle/evacshuttle
	name = "Evacshuttle"
	icon_state = "shuttle"
	requires_power = FALSE

/area/cadiaoutpost/oa/shuttle/mechrail

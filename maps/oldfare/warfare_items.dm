...
/obj/item/clothing/head/helmet/sentryhelm
	...
	armor = list(melee = 15, bullet = 35, laser = 25, energy = 40, bomb = 50, bio = 10, rad = 0)//proteck ya neck
	str_requirement = 18
...
/obj/item/clothing/suit/armor/sentry
	...
	armor = list(melee = 15, bullet = 35, laser = 25, energy = 40, bomb = 50, bio = 10, rad = 0)//Beefy boys.

...
/obj/singularity/narsie/large/New()
	...
	if(announce)
		...
		switch(rand(1,10))
			if(1)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie1.ogg'))
			if(2)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie2.ogg'))
			if(3)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie3.ogg'))
			if(4)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie4.ogg'))
			if(5)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie5.ogg'))
			if(6)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie6.ogg'))
			if(7)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie7.ogg'))
			if(8)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie8.ogg'))
			if(9)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsie9.ogg'))
			if(10)
				sound_to(world, sound('sound/effects/quotes/daemonprince/narsierus.ogg'))

...
/obj/item/clothing/head/culthood
	...
	armor = list(melee = 5, bullet = 10, laser = 5,energy = 30, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/head/culthood/magus
	...
	armor = list(melee = 7, bullet = 30, laser = 30, energy = 20, bomb = 15, bio = 0, rad = 0)
	sales_price = 10
...
/obj/item/clothing/suit/cultrobes
	...
	armor = list(melee = 5, bullet = 20, laser = 25,energy = 20, bomb = 25, bio = 10, rad = 0)
...
/obj/item/clothing/suit/cultrobes/magusred
	...
	armor = list(melee = 5, bullet = 22, laser = 25, energy = 30, bomb = 50, bio = 10, rad = 0)
	sales_price = 35
...
/obj/item/clothing/head/helmet/space/cult
	...
	armor = list(melee = 2, bullet = 30, laser = 30,energy = 33, bomb = 30, bio = 100, rad = 30) //Real tanky shit.
...
/obj/item/clothing/suit/space/cult
	...
	armor = list(melee = 3, bullet = 30, laser = 30,energy = 33, bomb = 30, bio = 100, rad = 30)
...
/obj/item/clothing/suit/cultist
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 10, bullet = 35, laser = 25, energy = 0, bomb = 10, bio = 5, rad = 5)
...
/obj/item/clothing/suit/witchhunter
	...
	armor = list(melee = 12, bullet = 65, laser = 60, energy = 35, bomb = 55, bio = 85, rad = 100)
...
/obj/item/clothing/head/witchhunter_hat
	...
	flags_inv = BLOCKHAIR
	armor = list(melee = 12, bullet = 40, laser = 42, energy = 35, bomb = 75, bio = 55, rad = 100) //We make the hat actually useful for the witch hunters to wear + Actually protects = Fear

...
*/
	...
	for(var/mob/living/silicon/ai/M in GLOB.living_mob_list_)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			var/target = pick("a heretic", "a syndicate agent", "a changeling", "a wizard", "the head of a revolution", "Soviet spy", "a good person", "a dwarf", "an elf", "a fairy princess", "the Rogue Trader", "Beepsky", "God", "a pirate", "a gryphon", "a chryssalid")

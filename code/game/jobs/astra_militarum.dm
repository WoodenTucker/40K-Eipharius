...
/datum/job/ig/sergeant
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.get_idcard()?.access = list(access_security, access_guard_common, access_forensics_lockers, access_all_personal_lockers, access_village, access_guard_armory, access_armory)
...
/datum/job/ig/medicae
	...
	minimal_access = list(access_medical, access_medical_equip, access_village,access_guard_common,access_security)

...
/mob/living/carbon/human/proc/chapterselection()
	...
	if(!ishuman(src))
		to_chat(src, "<span class='notice'>How tf are you seeing this? Go to the Discord and ping LeadOnTaste immediately</span>")
		return
	if(src.stat == DEAD)
	...
	var/static/list/chapter = list("Raven Guard", "Raven Guard Techmarine", "Raven Guard Apothecary", "Salamanders", "Salamanders Techmarine", "Salamanders Apothecary", "Ultramarines", "Ultramarines Techmarine", "Ultramarines Apothecary", "Blood Angels", "Blood Angels Techmarine", "Blood Angels Sanguinary Priest") //lists all possible chapters
	...
	switch(chapterchoice)
		if("Blood Angels")
			...
			equip_to_slot_or_del(new /obj/item/storage/backpack/satchel/astartes/bloodangel, slot_back)

...
//		H.witchblood() //Psyker Enforcers don't exist
		...
		to_chat(H, "<span class='notice'><b><font size=3>]You are an Arbitrator sent to a new colony by the Adeptus Arbites. Your task is to train the local enforcers and ensure order. .</font></b></span>")

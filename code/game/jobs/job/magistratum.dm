...
/datum/job/enforcer
	...
	minimal_access = list(access_security, access_sec_doors, access_magi, access_forensics_lockers, access_all_personal_lockers, access_village,
			            )
...
//		H.witchblood() //Psyker Enforcers don't exist
		...
		H.get_idcard()?.access = list(access_security, access_sec_doors, access_magi, access_forensics_lockers, access_all_personal_lockers, access_village,)
...
/datum/job/marshal
	...
	latejoin_at_spawnpoints = TRUE
	access = list(access_security, access_sec_doors, access_magi, access_forensics_lockers, access_all_personal_lockers, access_village, access_medical, access_medical_equip, access_village, access_administratum, access_change_ids, access_keycard_auth)
	minimal_access = list(access_security, access_sec_doors, access_magi, access_forensics_lockers, access_all_personal_lockers, access_village, access_medical, access_medical_equip, access_village, access_administratum, access_change_ids, access_keycard_auth
			            )

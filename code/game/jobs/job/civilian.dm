...
/datum/job/farmer
	...
	minimal_access = list(access_farm,)
	outfit_type = /decl/hierarchy/outfit/job/service/farmer
	announced = FALSE
	auto_rifle_skill = 3
	semi_rifle_skill = 3
	sniper_skill = 3
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.adjustStaminaLoss(-INFINITY)
		H.warfare_faction = IMPERIUM
		to_chat(H, "<span class='notice'><b><font size=3>You are one of the few skilled hands on this frozen hellscape capable of keeping these apostates from starving in the winter. Grow crops and sell your goods to the innkeeper. Try to climb yourself out of the bottom of the social hierarchy by becoming wealthy.</font></b></span>")

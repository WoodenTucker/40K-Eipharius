...
/datum/job/vindicare
	...
	spawn_positions = 1
	open_when_dead = FALSE
	outfit_type = /decl/hierarchy/outfit/job/vindicare
	auto_rifle_skill = 11
	semi_rifle_skill = 11
	sniper_skill = 11
	shotgun_skill = 11
	...
	equip(var/mob/living/carbon/human/H)
		H.warfare_faction = IMPERIUM
		..()
		H.add_stats(rand(18,18), rand(18,18), rand(18,18), rand (18,18)) //if you are a SNIPA you must be atleast a bit smarter than your average goardsoman
		H.add_skills(rand(8,10),rand(10,11),rand(3,6),rand(2,5),rand(1,5)) //melee, ranged, med, eng, surgery
		H.warfare_language_shit(LANGUAGE_LOW_GOTHIC)
		H.adjustStaminaLoss(-INFINITY)
		H.assign_random_quirk()
		...
		H.vice = null
		H.get_idcard()?.access = list(access_security, access_guard_common, access_all_personal_lockers, access_village)
		to_chat(H, "<span class='notice'><b><font size=3>  You're a sniper working for the governor. Shoot people. </font></b></span>")
		H.get_idcard()?.access = list(access_security, access_guard_common, access_all_personal_lockers, access_village)
// Sniper

/decl/hierarchy/outfit/job/vindicare
	name = OUTFIT_JOB_NAME("Vindicare Sniper")
	uniform = /obj/item/clothing/under/syndicate/combat
	suit = /obj/item/clothing/suit/armor/vindicare
	back = /obj/item/storage/backpack/satchel/warfare
	belt = null
	gloves = /obj/item/clothing/gloves/combat/cadian
	shoes = /obj/item/clothing/shoes/jackboots/cadian
	head = /obj/item/clothing/head/helmet/thallax
	mask = /obj/item/clothing/mask/gas/vindicare
	glasses = /obj/item/clothing/glasses/vindicare
	l_pocket = /obj/item/storage/box/ifak
	r_pocket = /obj/item/device/flashlight/lantern
	suit_store = /obj/item/gun/projectile/exitus
	neck = /obj/item/reagent_containers/food/drinks/canteen
	backpack_contents = list(
	/obj/item/ammo_magazine/exitus/explosive = 1,
	/obj/item/ammo_magazine/exitus/toxin = 1,
	/obj/item/ammo_magazine/exitus = 1,
	/obj/item/ammo_magazine/exitus/fire = 1
	)

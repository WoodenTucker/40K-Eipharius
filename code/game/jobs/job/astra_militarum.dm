...
/datum/job/ig
	...
	access = list(access_security, access_guard_common, access_forensics_lockers,
			            access_all_personal_lockers, access_village, access_armory)
	minimal_access = list(access_security, access_guard_common, access_forensics_lockers, access_all_personal_lockers, access_village, access_armory
			            )
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.witchblood()
		H.get_idcard()?.access = list(access_security, access_guard_common, access_forensics_lockers, access_all_personal_lockers, access_village)
...
/datum/job/ig/guardsman
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.get_idcard()?.access = list(access_security, , access_forensics_lockers, access_all_personal_lockers, access_village)
...
/datum/job/ig/sergeant
	...
	minimal_access = list(access_security, access_guard_common,access_forensics_lockers, access_all_personal_lockers, access_village, access_guard_armory, access_armory
			            )
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.get_idcard()?.access = list(access_security, access_guard_common, access_magi, access_forensics_lockers, access_all_personal_lockers, access_village, access_guard_armory, access_armory)
// Combat Medicae

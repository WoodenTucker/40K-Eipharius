...
/mob/living/carbon/human/proc/tzeentchcraftrecipe()
	...
	to_chat(src, "<font color='#0400ff'>Pyre -> Pistol.</font>")
	to_chat(src, "<font color='#0400ff'>Pistol + Iron Ingot -> Warmonger Revolver.</font>")
	to_chat(src, "<font color='#0400ff'>Candle + Poo -> Skinless.</font>")
	...
	to_chat(src, "<font color='#0400ff'>Chainsword + Pickaxe -> Trench Axe.</font>")
	...
	to_chat(src, "<font color='#0400ff'>Stub Rifle + Stub Rifle -> Sniper Rifle.</font>")
	...
	to_chat(src, "<font color='#0400ff'>Practitioner Boots + Combat Boots -> Valhallah Uniform.</font>")
	...
	to_chat(src, "<font color='#0400ff'>Penitent Jumpsuit + Iron Ingot -> Militia Suit.</font>")
...
//Uranium
			...
			if(do_after(usr,45,src))
				...
				if(prob(10))
					...
					new /obj/item/newore/copperore(src.loc)
//Astartes Helmet
		else if(istype(src.l_hand, /obj/item/clothing/head/helmet/astartes))
		...
		else if(istype(src.r_hand, /obj/item/clothing/head/helmet/astartes))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 50)
			if(do_after(usr,45,src))
				qdel(src.r_hand)
				new /obj/item/gun/projectile/bolter_pistol(src.loc)
...
//Trader Hat
			...
			if(do_after(usr,45,src))
				...
				new /obj/item/cell/lasgun(src.loc)
//Seneschal Hat
		else if(istype(src.l_hand, /obj/item/clothing/head/seneschal))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 50)
			if(do_after(usr,45,src))
				qdel(src.l_hand)
				new /obj/item/card/id/captains_spare(src.loc)
		else if(istype(src.r_hand, /obj/item/clothing/head/seneschal))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 50)
			if(do_after(usr,45,src))
				qdel(src.r_hand)
				new /obj/item/card/id/captains_spare(src.loc)
...
//Chainsword
			...
			if(do_after(usr,45,src))
				...
				new /obj/item/melee/chain/mercycs(src.loc)
//Trenchaxe
		else if((istype(src.l_hand, /obj/item/pickaxe)||istype(src.l_hand, /obj/item/pickaxe/newpick)) && istype(src.r_hand, /obj/item/melee/chain/mercycs))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 20)
			if(do_after(usr,45,src))
				qdel(src.l_hand)
				qdel(src.r_hand)
				new /obj/item/melee/trench_axe(src.loc)
		else if(istype(src.l_hand, /obj/item/melee/chain/mercycs) && (istype(src.r_hand, /obj/item/pickaxe)||istype(src.r_hand, /obj/item/pickaxe/newpick)))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 20)
			if(do_after(usr,45,src))
				qdel(src.l_hand)
				qdel(src.r_hand)
...
//Suture
			...
			if(do_after(usr,45,src))
				...
				new /obj/item/suture(src.loc)
//Khorneaxe
		else if(istype(src.l_hand, /obj/item/toothpuller))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 20)
			if(do_after(usr,45,src))
				qdel(src.l_hand)
				new /obj/item/melee/chain/pcsword/khorneaxe(src.loc)
		else if(istype(src.r_hand, /obj/item/toothpuller))
			playsound(src, 'sound/effects/quotes/cults/tzeentch/ritual.ogg', 100, 0, 20)
			if(do_after(usr,45,src))
				qdel(src.r_hand)
				new /obj/item/melee/chain/pcsword/khorneaxe(src.loc)

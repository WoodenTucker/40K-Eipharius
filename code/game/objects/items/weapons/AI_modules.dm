...
/obj/item/aiModule/protectStation
	...
	origin_tech = list(TECH_DATA = 3, TECH_MATERIAL = 3) //made of gold
...
/obj/item/aiModule/quarantine
	...
	origin_tech = list(TECH_DATA = 3, TECH_BIO = 2, TECH_MATERIAL = 3)
...
/obj/item/aiModule/tyrant // -- Darem
	...
	origin_tech = list(TECH_DATA = 3, TECH_MATERIAL = 3, TECH_ILLEGAL = 2)
...
/obj/item/aiModule/syndicate // Slightly more dynamic freeform module -- TLE
	...
	origin_tech = list(TECH_DATA = 3, TECH_MATERIAL = 3, TECH_ILLEGAL = 3)

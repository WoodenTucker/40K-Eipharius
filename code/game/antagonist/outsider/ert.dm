...
/datum/antagonist/ert/astartes
	id = MODE_ERT
	role_text = "Astartes"
	role_text_plural = "Astartes"
	welcome_text = "As member of the Adeptus Astartes, you answer only to your leader and your Chapter Master."
	antag_text = "You are an <b>anti</b> antagonist! Within the rules, \
		try to save the installation and its inhabitants from the ongoing crisis. \
		Try to make sure other players have <i>fun</i>! If you are confused or at a loss, always adminhelp, \
		and before taking extreme actions, please try to also contact the administration! \
...
/datum/antagonist/ert/astartes/New()
	..()
	leader_welcome_text = "As leader of the Astartes Killteam, you answer only to your Chapter Master and the Golden Throne, and have authority to override the Planetary Governor where it is necessary to achieve your mission goals. It is recommended that you attempt to cooperate with the Planetary Governor where possible, however."
	ert = src

/datum/antagonist/ert/astartes/greet(var/datum/mind/player)
	if(!..())
		return
	to_chat(player.current, "The Adeptus Astartes serve Mankind and the God-Emperor. You have been formed into a response team, conssiting of various individual. Obey your designated Leader.")
	to_chat(player.current, "You should first gear up and discuss a plan with your team. More members may be joining, don't move out before you're ready.")

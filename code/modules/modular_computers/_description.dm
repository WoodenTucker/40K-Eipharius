...
Research - Requires "Research and Development" access on ID card (ie. RD, Roboticist, etc.)
	...
	Robotics Monitor Console - Allows monitoring of robots and exosuits. Lockdown/Self-Destruct options are unavailable [balance reasons for malf/heretic AIs]. Requires extra access: "Robotics"

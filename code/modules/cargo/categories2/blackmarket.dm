...
/datum/noble_entry/bmarket/ritualknife
	name = "Ritual Knife"
	cost = 69
	item_path = /obj/item/melee/sword/skinning_knife

/datum/noble_entry/bmarket/chaosknife
	name = "Ch**s Knife"
	cost = 65
	item_path = /obj/item/melee/sword/chaosknife

/datum/noble_entry/bmarket/slaaneshsword
	name = "Sla**sh Blade"
	cost = 140
	item_path = /obj/item/melee/sword/slaanesh

/datum/noble_entry/bmarket/hellblade
	name = "H*ll Blade"
	cost = 280
	item_path = /obj/item/melee/sword/hellblade

/datum/noble_entry/bmarket/magushelm
	name = "Magus Helm"
	cost = 60
	item_path = /obj/item/clothing/head/culthood/magus

/datum/noble_entry/bmarket/magusrobes
	name = "Magus Robes"
	cost = 140

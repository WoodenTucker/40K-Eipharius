...
/datum/noble_entry/weapon/plasmarifle
	name = "Plasma Rifle"
	cost = 378
	item_path = /obj/item/gun/energy/pulse/plasma/rifle

/datum/noble_entry/weapon/flamer
	name = "Flamer"
	cost = 330

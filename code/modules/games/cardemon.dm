...
/obj/item/pack/cardemon/New()
	...
	for(i=0; i<6; i++)
		...
		var/nam = pick("Death","Life","Plant","Leaf","Air","Earth","Fire","Water","Killer","Holy", "God", "Ordinary","Daemon","Angel", "Phoron", "Mad", "Insane", "Metal", "Steel", "Secret")
		var/nam2 = pick("Carp", "Corgi", "Cat", "Mouse", "Octopus", "Lizard", "Monkey", "Plant", "Duck", "Daemon", "Spider", "Bird", "Shark", "Rock")

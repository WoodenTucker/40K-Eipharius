...
/datum/reagent/toxin/mustard_gas/white_phosphorus/affect_touch(var/mob/living/carbon/human/M, var/alien, var/removed)
	if(ishuman(target))
		...
		if(!istype(M.wear_suit, /obj/item/clothing/suit/fire || /obj/item/clothing/suit/armor/astartes ||  /obj/item/clothing/suit/sisterofbattle || /obj/item/clothing/suit/armor/ordohereticus || obj/item/clothing/suit/armor/scion))
			if(prob(50))

...
/obj/item/clothing/suit/armor/guardsman
	...
	item_state = "farmor"
	allowed = list(/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/cell,/obj/item/gun/energy/las/lasgun)
	armor = list(melee = 20, bullet = 20, laser = 20, energy = 20, bomb = 30, bio = 10, rad = 20)
	sales_price = 20
...
/obj/item/clothing/suit/armor/guardsman/carapace
	...
	icon_state = "fharmor"
	item_state = "fharmor"
	armor = list(melee = 30, bullet = 30, laser = 30, energy = 30, bomb = 40, bio = 10, rad = 20)
	sales_price = 35
...
/obj/item/clothing/suit/armor/greypa
	...
	allowed = list(/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/cell,/obj/item/gun/energy/las/lasgun)
	armor = list(melee = 80, bullet = 68, laser = 68, energy = 35, bomb = 50, bio = 100, rad = 100)
	sales_price = 90
	cold_protection = UPPER_TORSO | LOWER_TORSO | LEGS | FEET | ARMS | HANDS
	min_cold_protection_temperature = SPACE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS|HANDS|FEET

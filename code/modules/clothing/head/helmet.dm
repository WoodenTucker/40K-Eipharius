...
/obj/item/clothing/head/helmet/tactical
	...
	armor = list(melee = 5, bullet = 30, laser = 20, energy = 25, bomb = 30, bio = 0, rad = 10)
...
/obj/item/clothing/head/helmet/merc
	...
	armor = list(melee = 5, bullet = 35, laser = 25, energy = 35, bomb = 30, bio = 0, rad = 10)
...
/obj/item/clothing/head/helmet/barney_helmet
	...
	armor = list(melee = 5, bullet = 30, laser = 10, energy = 35, bomb = 30, bio =0, rad = 10)
	sales_price = 2
...
/obj/item/clothing/head/helmet/riot
	...
	armor = list(melee = 12, bullet = 40, laser = 60, energy = 15, bomb = 40, bio = 12, rad = 20)
	siemens_coefficient = 0.7
...
/obj/item/clothing/head/helmet/thunderdome
	...
	valid_accessory_slots = null
	armor = list(melee = 2, bullet = 30, laser = 30,energy = 10, bomb = 25, bio = 10, rad = 0)
	cold_protection = HEAD
...
/obj/item/clothing/head/helmet/augment
	...
	icon_state = "v62"
	valid_accessory_slots = null
	armor = list(melee = 10, bullet = 20, laser = 20,energy = 20, bomb = 20, bio = 10, rad = 0)
...
/obj/item/clothing/head/helmet/flak
	...
	icon_state = "guard"
	armor = list(melee = 5, bullet = 30, laser = 30, energy = 25, bomb = 25, bio = 0, rad = 10)
	siemens_coefficient = 0.6
...
/obj/item/clothing/head/helmet/scion
	...
	item_state = "guard"
	armor = list(melee = 8, bullet = 35, laser = 35, energy = 35, bomb = 35, bio = 0, rad = 10)
	siemens_coefficient = 0.6
	sales_price = 15
...
/obj/item/clothing/head/helmet/orkhelmet
	...
	icon_state = "ork_helm"
	item_state = "ork_helm"
	armor = list(melee = 10, bullet = 30, laser = 30, energy = 25, bomb = 25, bio = 0, rad = 0)
	siemens_coefficient = 1
	body_parts_covered = HEAD
	cold_protection = HEAD
...
/obj/item/clothing/head/helmet/witch
	...
	armor = list(melee = 10, bullet = 30, laser = 30, energy = 35, bomb = 30, bio = 30, rad = 30)
	sales_price = 0
	icon_state = "brim-hat"
	item_state = "brim-hat"
	flags_inv = BLOCKHEADHAIR
...
/obj/item/clothing/head/helmet/soul
	...
	icon_state = "soul"
	item_state = "soul"
	armor = list(melee = 10, bullet = 30, laser = 38, energy = 35, bomb = 50, bio = 100, rad = 50)
	sales_price = 0
...
/obj/item/clothing/head/helmet/seolhelm
	...
	icon_state = "seolhelm"
	item_state = "seolhelm"
	armor = list(melee = 10, bullet = 38, laser = 41, energy = 35, bomb = 50, bio = 100, rad = 50)
	sales_price = 0
...
/obj/item/clothing/head/helmet/hauberk
	...
	armor = list(melee = 12, bullet = 20, laser = 20, energy = 35, bomb = 10, bio = 20, rad = 10)
	sales_price = 1
...
/obj/item/clothing/head/helmet/hevhelm
	...
	icon_state = "hevhelm"
	item_state = "hevhelm"
	armor = list(melee = 12, bullet = 20, laser = 25, energy = 35, bomb = 30, bio = 50, rad = 30)
	sales_price = 2
...
/obj/item/clothing/head/helmet/hevhelm/palace
	...
	item_state = "hevhelm"
	color = "#ad9b30"
	armor = list(melee = 10, bullet = 20, laser = 25, energy = 35, bomb = 30, bio = 50, rad = 30)
	sales_price = 2
...
/obj/item/clothing/head/helmet/sheriff
	...
	armor = list(melee = 5, bullet = 25, laser = 15, energy = 35, bomb = 10, bio = 0, rad = 10)
	sales_price = 1
...
/obj/item/clothing/head/helmet/marinehelm
	...
	armor = list(melee = 8, bullet = 24, laser = 24, energy = 35, bomb = 20, bio = 10, rad = 10)
	sales_price = 1
...
/obj/item/clothing/head/helmet/foxhelm
	...
	icon_state = "foxhelm"
	item_state = "foxhelm"
	armor = list(melee = 8, bullet = 32, laser = 32, energy = 35, bomb = 10, bio = 40, rad = 30)
	sales_price = 2
...
/obj/item/clothing/head/helmet/lightpahelm
	...
	armor = list(melee = 12, bullet = 37, laser = 39, energy = 35, bomb = 50, bio = 50, rad = 30)
	sales_price = 10
...
/obj/item/clothing/head/helmet/berserkerhelm
	...
	armor = list(melee = 7, bullet = 34, laser = 34, energy = 30, bomb = 60, bio = 60, rad = 40)
	sales_price = 15
...
/obj/item/clothing/head/helmet/reconhood
	...
	icon_state = "reconhood"
	item_state = "reconhood"
	armor = list(melee = 7, bullet = 25, laser = 25, energy = 35, bomb = 10, bio = 30, rad = 20)
	sales_price = 1
...
/obj/item/clothing/head/helmet/metalhelmet
	...
	armor = list(melee = 6, bullet = 21, laser = 21, energy = 10, bomb = 10, bio = 30, rad = 20)
	sales_price = 1
...
/obj/item/clothing/head/helmet/knighthelm
	...
	armor = list(melee = 9, bullet = 21, laser = 24, energy = 15, bomb = 15, bio = 30, rad = 20)
	sales_price = 2
...
/obj/item/clothing/head/helmet/dragon
	...
	icon_state = "dragon"
	item_state = "dragon"
	armor = list(melee = 9, bullet = 25, laser = 25, energy = 35, bomb = 20, bio = 30, rad = 20)
	sales_price = 2
...
/obj/item/clothing/head/helmet/metalvisor
	...
	icon_state = "leglad"
	item_state = "leglad"
	armor = list(melee = 10, bullet = 15, laser = 15, energy = 10, bomb = 10, bio = 30, rad = 20)
	sales_price = 1
...
/obj/item/clothing/head/helmet/stalkerhelm
	...
	armor = list(melee = 11, bullet = 28, laser = 28, energy = 35, bomb = 50, bio = 70, rad = 50)
	sales_price = 2
...
/obj/item/clothing/head/helmet/bond
	...
	armor = list(melee = 12, bullet = 28, laser = 28, energy = 15, bomb = 50, bio = 70, rad = 70)
	sales_price = 2
...
/obj/item/clothing/head/helmet/heavyflak/bloodpact
	...
	armor = list(melee = 8, bullet = 32, laser = 33, energy = 35, bomb = 50, bio = 70, rad = 50)
	sales_price = 2
...
/obj/item/clothing/head/helmet/tscion //Make sure to reference tscion, there's an older scion helmet.
	...
	armor = list(melee = 7, bullet = 40, laser = 40, energy = 35, bomb = 60, bio = 100, rad = 60)
	siemens_coefficient = 0
	flags_inv = BLOCKHAIR
	body_parts_covered = HEAD|FACE|EYES

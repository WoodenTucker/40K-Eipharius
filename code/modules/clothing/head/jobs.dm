...
/obj/item/clothing/head/helmet/sisterofbattle
	...
	icon_state = "sister"
	item_state = "sister"
	armor = list(melee = 35, bullet = 44, laser = 44, energy = 30, bomb = 40, bio = 100, rad = 100)
	sales_price = 50
...
/obj/item/clothing/head/helmet/sisterofbattle/repentia
	...
	armor = list(melee = 38, bullet = 35, laser = 35, energy = 30, bomb = 40, bio = 40, rad = 40)
...
/obj/item/clothing/head/ogryn
	name = "ogryn head"
	desc = "UH OH"
	armor = list(melee = 30, bullet = 30, laser = 30, energy = 30, bomb = 40, bio = 40, rad = 40)

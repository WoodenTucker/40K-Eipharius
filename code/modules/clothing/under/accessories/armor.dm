...
/obj/item/clothing/accessory/storage/torso/armor
	...
	armor = list(melee = 2, bullet = 14, laser = 14, energy = 1, bomb = 15, bio = 0, rad = 5)
...
/obj/item/clothing/accessory/armorplate
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 1, bullet = 30, laser = 30, energy = 10, bomb = 25, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armorplate/medium
	...
	armor = list(melee = 1, bullet = 40, laser = 30, energy = 25, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armorplate/tactical
	...
	armor = list(melee = 1, bullet = 40, laser = 30, energy = 35, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armorplate/merc
	...
	armor = list(melee = 5, bullet = 50, laser = 40, energy = 40, bomb = 40, bio = 0, rad = 0)
	slowdown = 1
...
/obj/item/clothing/accessory/armguards
	...
	armor = list(melee = 1, bullet = 8, laser = 4, energy = 4, bomb = 4, bio = 0, rad = 0)
	slot = ACCESSORY_SLOT_ARMOR_A
...
/obj/item/clothing/accessory/armguards/riot
	...
	armor = list(melee = 1, bullet = 4, laser = 4, energy = 4, bomb = 2, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armguards/ballistic
	...
	armor = list(melee = 2, bullet = 8, laser = 4, energy = 4, bomb = 4, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/legguards
	...
	armor = list(melee = 1, bullet = 4, laser = 2, energy = 2, bomb = 2, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/legguards/merc
	...
	armor = list(melee = 2, bullet = 4, laser = 2, energy = 2, bomb = 2, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/legguards/riot
	...
	armor = list(melee = 1, bullet = 1, laser = 1, energy = 2, bomb = 2, bio = 0, rad = 0)
	siemens_coefficient = 0.5
	slowdown = 1
...
/obj/item/clothing/accessory/legguards/ballistic
	...
	armor = list(melee = 1, bullet = 8, laser = 1, energy = 2, bomb = 2, bio = 0, rad = 0)
	siemens_coefficient = 0.7
	slowdown = 1

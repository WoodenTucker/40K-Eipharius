...
/mob/living/carbon/human/proc/add_stats(var/strength, var/dexterity, var/endurance, var/intelligence, var/psyker,)//TODO: Make this more atomic.
	if(strength)
	...
	if(psyker)
		if(has_quirk(/datum/quirk/witchblood))
			src.psyker = 1
	updateweight()

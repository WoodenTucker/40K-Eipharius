#define BORER_EXP_LEVEL_1 10
#define BORER_EXP_LEVEL_2 20
#define BORER_EXP_LEVEL_3 40
#define BORER_EXP_LEVEL_4 60
#define BORER_EXP_LEVEL_5 80
...
/mob/living/simple_animal/borer/proc/detatch()
	...
	host.remove_language(LANGUAGE_TYRANID)
	update_abilities()
...
/mob/living/simple_animal/borer/proc/update_borer_level()
	if((borer_exp >= BORER_EXP_LEVEL_1) && (borer_level < 1))
		var/level = 1
		var/added_reagents = list("inaprovaline", "tricordrazine", "synaptizine", "imidazoline", "hyronalin", "citalopram", "glucose", "soporific",)
	...
	if((borer_exp >= BORER_EXP_LEVEL_3) && (borer_level < 3))
		var/level = 3
		var/added_reagents = list("meralyne", "dermaline", "dexalinp", "oxycodone", "ryetalyn", "adrenaline", "paroxetine")
	...
	if((borer_exp >= BORER_EXP_LEVEL_5) && (borer_level < 5))
		var/level = 5
		var/added_reagents = list("nicotine", "methylphenidate", "nanoblood")

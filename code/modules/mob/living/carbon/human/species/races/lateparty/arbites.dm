	...
	switch(arbitetype)
		if("Close Quarters Specialist")
			equip_to_slot_or_del(new /obj/item/clothing/suit, slot_wear_suit)
			equip_to_slot_or_del(new /obj/item/clothing/glasses, slot_glasses)
			...
			equip_to_slot_or_del(new /obj/item/ammo_magazine/, slot_in_backpack)
			equip_to_slot_or_del(new /obj/item/ammo_magazine/, slot_in_backpack)
			equip_to_slot_or_del(new /obj/item/ammo_magazine/, slot_in_backpack)
			equip_to_slot_or_del(new /obj/item/ammo_magazine/, slot_in_backpack)
			equip_to_slot_or_del(new /obj/item/gun/projectile/automatic/, slot_s_store)

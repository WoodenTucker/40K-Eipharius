...
/datum/species/human/necron
	name = SPECIES_NECRON
	brute_mod =      0.2                   //Why are you trying to punch a metal robot to death
	burn_mod =       0.4                  //Once more, they are metal. The armor values compensate for the fact that they lack any armor as of now.
	blurb = "A Necron Warrior, without both a soul or care"
	max_age = 120000000
	...
	total_health = 700 // Astartes have 350 brain health, necrons have twice that due to being robots
	...
	species_flags = SPECIES_FLAG_NO_PAIN|SPECIES_FLAG_NO_SLIP|SPECIES_FLAG_NO_POISON
	inherent_verbs = list(

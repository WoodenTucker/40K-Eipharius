...
/material/proc/generate_recipes()
	...
	if(integrity>=50)
		...
		recipes += new/datum/stack_recipe("[display_name] barricade", /obj/structure/warfare/barricade/concrete_barrier, 5, time = 50, one_per_turf = 1, on_floor = 1, supplied_material = "[name]")

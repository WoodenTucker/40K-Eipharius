...
/material/scrap/generate_recipes()
	..()
	recipes += new/datum/stack_recipe("Shoota Boy Armor", /obj/item/clothing/suit/armor/orkarmor/snazzy, 10, 1, 1, 10)
	recipes += new/datum/stack_recipe("Shoota Boy Helmet", /obj/item/clothing/head/helmet/orkhelmet/sight, 10, 1, 1, 10)
	recipes += new/datum/stack_recipe("Slugga Boy Armor", /obj/item/clothing/suit/armor/orkarmor/skullza, 10, 1, 1, 10)
	recipes += new/datum/stack_recipe("Slugga Boy Helmet", /obj/item/clothing/head/helmet/orkhelmet/horns, 10, 1, 1, 10)
	recipes += new/datum/stack_recipe("Eavy Metal Armor", /obj/item/clothing/suit/armor/orkarmor, 24, 1, 1, 10)
	recipes += new/datum/stack_recipe("Eavy Metal Helmet", /obj/item/clothing/head/helmet/orkhelmet, 16, 1, 1, 10)
	recipes += new/datum/stack_recipe("Shoota", /obj/item/gun/projectile/ork/automatic/shoota, 12, 1, 1, 20, on_floor = 1)
	recipes += new/datum/stack_recipe("Shoota magazine", /obj/item/ammo_magazine/ork/shoota, 8, 1, 1, 0, on_floor = 1)
	recipes += new/datum/stack_recipe("Slugga", /obj/item/gun/projectile/ork/slugga, 6, 1, 1, 20, on_floor = 1)
	recipes += new/datum/stack_recipe("Slugga magazine", /obj/item/ammo_magazine/ork/slugga, 4, 1, 1, 0, on_floor = 1)
	recipes += new/datum/stack_recipe("Pipe Grenade", /obj/item/grenade/frag/high_yield/homemade, 4, 1, 1, 0, on_floor = 1)
	...
	recipes += new/datum/stack_recipe("ork banner", /obj/structure/orkbanna, 5, 1, 1, 20, on_floor = 1)

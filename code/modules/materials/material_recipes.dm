...
/material/scrap/generate_recipes()
	...
	recipes += new/datum/stack_recipe("slugga", /obj/item/gun/projectile/ork/slugga, 10, 1, 1, 20, on_floor = 1)
	recipes += new/datum/stack_recipe("shoota magazine", /obj/item/ammo_magazine/ork/shoota, 7, 1, 1, 0, on_floor = 1)

...
/material/scrap/generate_recipes()
	...
	recipes += new/datum/stack_recipe("Big Shoota", /obj/item/gun/projectile/ork/automatic/shoota/big, 14, 1, 1, 20, on_floor = 1)
	recipes += new/datum/stack_recipe("Furtha Shoota", /obj/item/gun/projectile/ork/automatic/shoota/furtha, 16, 1, 1, 20, on_floor = 1)

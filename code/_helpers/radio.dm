...
var/list/ANTAG_FREQS = list(RED_FREQ, RED_ALPHA, RED_BRAVO, RED_CHARLIE, RED_DELTA, BLUE_FREQ, BLUE_ALPHA, BLUE_BRAVO, BLUE_CHARLIE, BLUE_DELTA, HIVE_FREQ, RED_INQ, COMM_FREQ, ENG_FREQ, MED_FREQ)

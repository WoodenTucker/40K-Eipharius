...
/datum/controller/subsystem/shuttles/fire(resumed = FALSE)
	if (!resumed)
...
/datum/controller/subsystem/shuttles/proc/initialize_sector(obj/effect/overmap/given_sector)
...
/datum/controller/subsystem/shuttles/proc/try_add_landmark_tag(landmark_tag, obj/effect/overmap/given_sector)
...
/datum/controller/subsystem/shuttles/proc/initialise_shuttle(var/shuttle_type, during_init = FALSE)
